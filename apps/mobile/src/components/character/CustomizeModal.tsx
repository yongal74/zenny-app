...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 20, fontFamily: 'DMSans_700Bold', color: theme.colors.text.primary },
    ...
    coinsLabel: { fontSize: 14, color: theme.colors.gold, fontFamily: 'DMSans_500Medium' },
    ...
    tabText: { fontSize: 13, fontFamily: 'DMSans_500Medium', color: theme.colors.text.tertiary },
    ...
    priceText: { fontSize: 12, fontFamily: 'DMSans_500Medium' },
