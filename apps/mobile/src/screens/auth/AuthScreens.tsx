...
const styles = StyleSheet.create({
    ...
    appName: { fontSize: 36, fontFamily: 'DMSans_700Bold', color: theme.colors.text.primary, marginBottom: 4 },
    tagline: { fontSize: 14, color: theme.colors.text.secondary, fontFamily: 'DMSans_400Regular' },
    title: { fontSize: 24, fontFamily: 'DMSans_700Bold', color: theme.colors.text.primary },
});
