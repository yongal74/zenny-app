...
async function main() {
    ...
    await prisma.meditationTrack.createMany({
        ...
        data: [
            // ── EN 10개 ──
            { id: 'en-breath-box-01',      title: '2-Min Box Breathing',       titleKo: '박스 호흡 2분',       type: 'breathing', emotion: 'stressed', lang: 'en', duration: 120, audioUrl: `${CDN}/en/breath-box-01.mp3`,       musicUrl: `${MUSIC}/calm-focus-01.mp3`,   imageUrl: P('zen-box-breath-01'),    weekCreated: '2026-W09' },
            { id: 'en-breath-478-01',      title: '4-7-8 Anxiety Relief',      titleKo: '4-7-8 불안 해소',     type: 'breathing', emotion: 'anxious',  lang: 'en', duration: 120, audioUrl: `${CDN}/en/breath-478-01.mp3`,       musicUrl: `${MUSIC}/soft-rain-01.mp3`,    imageUrl: P('misty-calm-lake-02'),   weekCreated: '2026-W09' },
            { id: 'en-body-scan-01',       title: 'Full Body Relaxation Scan', titleKo: '전신 이완 스캔',       type: 'bodyscan',  emotion: 'tired',    lang: 'en', duration: 120, audioUrl: `${CDN}/en/body-scan-01.mp3`,        musicUrl: `${MUSIC}/deep-calm-01.mp3`,    imageUrl: P('bodyscan-meadow-03'),   weekCreated: '2026-W09' },
            { id: 'en-guided-love-01',     title: 'Loving Kindness (Metta)',   titleKo: '자애 명상',           type: 'guided',    emotion: 'lonely',   lang: 'en', duration: 120, audioUrl: `${CDN}/en/loving-kindness-01.mp3`,  musicUrl: `${MUSIC}/warm-glow-01.mp3`,    imageUrl: P('golden-warm-light-04'), weekCreated: '2026-W09' },
            { id: 'en-guided-zen-01',      title: 'Zen Stillness',             titleKo: '선 고요 명상',         type: 'guided',    emotion: 'stressed', lang: 'en', duration: 120, audioUrl: `${CDN}/en/zen-stillness-01.mp3`,    musicUrl: `${MUSIC}/zen-bells-01.mp3`,    imageUrl: P('stone-garden-zen-05'),  weekCreated: '2026-W09' },
            { id: 'en-nature-rain-01',     title: 'Rain Forest Calm',          titleKo: '숲속 빗소리',          type: 'nature',    emotion: 'tired',    lang: 'en', duration: 120, audioUrl: `${CDN}/en/rain-forest-01.mp3`,      musicUrl: `${MUSIC}/forest-rain-01.mp3`,  imageUrl: P('forest-rain-drops-06'), weekCreated: '2026-W09' },
            { id: 'en-nature-ocean-01',    title: 'Ocean Waves Meditation',    titleKo: '파도 소리 명상',       type: 'nature',    emotion: 'anxious',  lang: 'en', duration: 120, audioUrl: `${CDN}/en/ocean-waves-01.mp3`,      musicUrl: `${MUSIC}/ocean-calm-01.mp3`,   imageUrl: P('ocean-horizon-dusk-07'),weekCreated: '2026-W09' },
            { id: 'en-breath-pranayama-01',title: 'Pranayama Breathwork',      titleKo: '프라나야마 호흡',       type: 'breathing', emotion: 'confused', lang: 'en', duration: 120, audioUrl: `${CDN}/en/pranayama-01.mp3`,        musicUrl: `${MUSIC}/deep-breath-01.mp3`,  imageUrl: P('sunrise-yoga-field-08'),weekCreated: '2026-W09' },
            { id: 'en-guided-stoic-01',    title: 'Stoic Morning Reflection',  titleKo: '스토아 아침 명상',      type: 'guided',    emotion: 'sad',      lang: 'en', duration: 120, audioUrl: `${CDN}/en/stoic-morning-01.mp3`,    musicUrl: `${MUSIC}/morning-light-01.mp3`,imageUrl: P('dawn-mountain-path-09'),weekCreated: '2026-W09' },
            { id: 'en-guided-gratitude-01',title: 'Gratitude Visualization',   titleKo: '감사 시각화',          type: 'guided',    emotion: 'happy',    lang: 'en', duration: 120, audioUrl: `${CDN}/en/gratitude-01.mp3`,        musicUrl: `${MUSIC}/bright-joy-01.mp3`,   imageUrl: P('sunlit-cherry-bloom-10'),weekCreated: '2026-W09' },

            // ── KO 10개 ──
            { id: 'ko-breath-box-01',      title: 'Box Breathing 2분',         titleKo: '박스 호흡 2분',        type: 'breathing', emotion: 'stressed', lang: 'ko', duration: 120, audioUrl: `${CDN}/ko/breath-box-01.mp3`,       musicUrl: `${MUSIC}/calm-focus-01.mp3`,   imageUrl: P('calm-water-ripple-11'), weekCreated: '2026-W09' },
            { id: 'ko-breath-478-01',      title: '4-7-8 Breathing',           titleKo: '4-7-8 불안 해소 호흡', type: 'breathing', emotion: 'anxious',  lang: 'ko', duration: 120, audioUrl: `${CDN}/ko/breath-478-01.mp3`,       musicUrl: `${MUSIC}/soft-rain-01.mp3`,    imageUrl: P('soft-mist-valley-12'),  weekCreated: '2026-W09' },
            { id: 'ko-body-scan-01',       title: 'Body Scan',                 titleKo: '전신 바디스캔',         type: 'bodyscan',  emotion: 'tired',    lang: 'ko', duration: 120, audioUrl: `${CDN}/ko/body-scan-01.mp3`,        musicUrl: `${MUSIC}/deep-calm-01.mp3`,    imageUrl: P('moonlit-forest-path-13'),weekCreated: '2026-W09' },
            { id: 'ko-guided-love-01',     title: 'Loving Kindness',           titleKo: '자애 명상 (메타)',      type: 'guided',    emotion: 'lonely',   lang: 'ko', duration: 120, audioUrl: `${CDN}/ko/loving-kindness-01.mp3`,  musicUrl: `${MUSIC}/warm-glow-01.mp3`,    imageUrl: P('lotus-pond-sunrise-14'),weekCreated: '2026-W09' },
            { id: 'ko-guided-zen-01',      title: 'Zen Stillness',             titleKo: '선(禪) 고요 명상',     type: 'guided',    emotion: 'stressed', lang: 'ko', duration: 120, audioUrl: `${CDN}/ko/zen-stillness-01.mp3`,    musicUrl: `${MUSIC}/zen-bells-01.mp3`,    imageUrl: P('bamboo-grove-still-15'),weekCreated: '2026-W09' },
            { id: 'ko-nature-rain-01',     title: 'Rain Forest',               titleKo: '숲속 빗소리',           type: 'nature',    emotion: 'tired',    lang: 'ko', duration: 120, audioUrl: `${CDN}/ko/rain-forest-01.mp3`,      musicUrl: `${MUSIC}/forest-rain-01.mp3`,  imageUrl: P('deep-green-leaves-16'), weekCreated: '2026-W09' },
            { id: 'ko-nature-ocean-01',    title: 'Ocean Waves',               titleKo: '파도 소리 명상',        type: 'nature',    emotion: 'anxious',  lang: 'ko', duration: 120, audioUrl: `${CDN}/ko/ocean-waves-01.mp3`,      musicUrl: `${MUSIC}/ocean-calm-01.mp3`,   imageUrl: P('coastal-blue-tide-17'), weekCreated: '2026-W09' },
            { id: 'ko-breath-pranayama-01',title: 'Pranayama',                 titleKo: '프라나야마 호흡법',     type: 'breathing', emotion: 'confused', lang: 'ko', duration: 120, audioUrl: `${CDN}/ko/pranayama-01.mp3`,        musicUrl: `${MUSIC}/deep-breath-01.mp3`,  imageUrl: P('highland-morning-mist-18'),weekCreated: '2026-W09' },
            { id: 'ko-guided-cbt-01',      title: 'CBT Morning',               titleKo: 'CBT 기반 아침 명상',   type: 'guided',    emotion: 'sad',      lang: 'ko', duration: 120, audioUrl: `${CDN}/ko/cbt-morning-01.mp3`,      musicUrl: `${MUSIC}/morning-light-01.mp3`,imageUrl: P('golden-hour-hillside-19'),weekCreated: '2026-W09' },
            { id: 'ko-guided-gratitude-01',title: 'Gratitude',                 titleKo: '감사 시각화 명상',      type: 'guided',    emotion: 'happy',    lang: 'ko', duration: 120, audioUrl: `${CDN}/ko/gratitude-01.mp3`,        musicUrl: `${MUSIC}/bright-joy-01.mp3`,   imageUrl: P('wildflower-meadow-20'), weekCreated: '2026-W09' },
        ],
    });
